# -*- coding: utf-8 -*-
"""cluster2_riskscores.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bqmYx3BglpTCsGmF5L_K3ge_lvcZdujn
"""
...
df = pd.read_csv('/content/drive/MyDrive/Copy of df2.csv')
...
df = df.drop(['Cluster_Labels','ACS_MEDIAN_HH_INC_HISP', 'ACS_PCT_ASIAN_FEMALE', 'ACS_PCT_ASIAN_MALE', 'ACS_PCT_PUB_COMMT_29MIN', 'ACS_PCT_PUB_COMMT_59MIN', 'ACS_PCT_VET_UNEMPL_18_64'],axis=1)
...
pca_ho=pd.read_csv('/content/df_new_pca.csv')
...
# Assuming df is your DataFrame
selected_columns = [
    'ACS_PCT_FOREIGN_BORN', 'ACS_PCT_WHITE',
     'ACS_PCT_CHILD_DISAB', 'ACS_PCT_DISABLE',
    'ACS_PCT_NONVET_DISABLE_18_64', 'ACS_PCT_VET_DISABLE_18_64','ACS_PCT_BLACK_COMB',
'ACS_PCT_ASIAN_COMB',
'ACS_PCT_BLACK',
...
X = data[DiscriminationRiskFeatures]
...
Housing_Risk_Features=[ 'ACS_PCT_MEDICAID_ANY', 'ACS_PCT_MEDICAID_ANY_BELOW64', 'ACS_PCT_PRIVATE_MDCR_35_64',
    'ACS_PCT_UNINSURED', 'ACS_PCT_UNINSURED_BELOW64', 'ACS_PCT_CHILDREN_GRANDPARENT','ACS_PER_CAPITA_INC',
    'ACS_PCT_CHILD_1FAM', 'ACS_PCT_HH_1PERS', 'ACS_PCT_HH_ABOVE65', 'ACS_PCT_HH_ALONE_ABOVE65',
...
X = data[FamilyConflictRisk_Features]
...
# Select the relevant columns from df_plotting
columns_of_interest = ['PCA_Variable'] + FamilyConflictRisk_Features
subset_df = df_plotting[columns_of_interest]
...
TransportationRisk_Features=[ 'ACS_PCT_COMMT_15MIN', 'ACS_PCT_COMMT_29MIN', 'ACS_PCT_COMMT_59MIN', 'ACS_PCT_COMMT_60MINUP',
    'ACS_PCT_HU_NO_VEH', 'ACS_PCT_PUBL_TRANSIT', 'ACS_PCT_PUB_COMMT_15MIN', 'ACS_PCT_PUB_COMMT_60MINUP', 'ACS_PCT_RENTER_HU_COST_30PCT',
...
X = data[TransportationRisk_Features]
...
X = data[EnvironmentalRisk_Feature]
y = data[['Obesity among adults aged >=18 years',
 'Current asthma among adults aged >=18 years',
 'Current smoking among adults aged >=18 years',
 'Mammography use among women aged 50-74 years',
...
csv_filename = '/content/drive/My Drive/cluster2.csv'  # Change this to your desired file path
df_plotting.to_csv(csv_filename, index=False)
